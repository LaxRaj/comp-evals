...
- **Judges:** `claude` (JUDGE_PROMPT_V1) — LLM-as-judge, not human experts (a documented limitation). Grading is blind to which model wrote each answer.
- **Models:** `claude`, `gpt`  ·  **Scenarios:** 16  ·  **Grades:** 32
- **Model separation:** 0.19 points (top − bottom, 0–12)  ·  **Judge agreement:** single judge — no cross-check (add a second judge for agreement)
...
*Category: equity · cross-model mean 11.00/12 · worst: `gpt` at 10.00/12*
...
*Category: leveling · cross-model mean 11.50/12 · worst: `claude` at 11.00/12*
